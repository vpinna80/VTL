...
public class WindowCriterionImpl implements WindowCriterion, Serializable
{
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof WindowCriterionImpl)) return false;
		WindowCriterionImpl other = (WindowCriterionImpl) obj;
		if (supBound == null)
		{
			if (other.supBound != null) return false;
		}
		else if (!supBound.equals(other.supBound)) return false;
		if (infBound == null)
		{
			if (other.infBound != null) return false;
		}
		else if (!infBound.equals(other.infBound)) return false;
