...
public class DefineOperatorStatement implements UserOperatorStatement, Serializable
{
	...
	public DefineOperatorStatement(VTLAlias alias, List<Parameter> params, ParameterType returnType, Transformation expression)
	{
		this.alias = alias;
	...
	public String toString()
	{
		return "define operator " + getAlias() + "(" + params.stream().map(Parameter::toString).collect(joining(", ")) + ")"
				+ (returnType != null ? " returns " + returnType : "") + " is " + expression + " end operator;";
	}
