...
public enum SampleVariables
{
	...
	MEASURE_STRING_1, MEASURE_STRING_2, MEASURE_STRING_3, MEASURE_STRING_4, MEASURE_STRING_5, MEASURE_STRING_6, MEASURE_STRING_7, MEASURE_STRING_8, 
	...
	private SampleVariables()
	{
		...
		component = DataSetComponentImpl.of(VTLAliasImpl.of(elem[1].toLowerCase() + "_" + elem[2]), domain, role);
	}
	
	public DataSetComponent<?, ?, ?> getComponent(int level)
	{
