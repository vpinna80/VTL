...
public class VTLTimePatterns
{
	...
	static {
		...
		PATTERNS.put(Pattern.compile("^(M[Oo][Nn][Tt][Hh])(?!1|3)(.*)$"), dtf -> dtf.appendText(MONTH_OF_YEAR, FULL));
		...
		PATTERNS.put(Pattern.compile("^(D[Aa][Yy])(?!1|3)(.*)$"), dtf -> dtf.appendText(DAY_OF_WEEK, FULL));
		PATTERNS.put(Pattern.compile("^(MM)(.*)$"), dtf -> dtf.appendValue(MONTH_OF_YEAR, 2));
		PATTERNS.put(Pattern.compile("^(M)(?!M)(.*)$"), dtf -> dtf.appendValue(MONTH_OF_YEAR, 1, 2, NOT_NEGATIVE));
